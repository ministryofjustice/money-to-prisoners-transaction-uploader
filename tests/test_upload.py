...
class TransactionsFromFileTestCase(TestCase):
    ...
    def test_marks_incomplete_remitter_information(self):
        with open('tests/data/testfile_remitter_information') as f:
            data_services_file = parse(f)
        ...
        self.assertTrue(transactions[1]['incomplete_remitter_info'])

        self.assertEqual(transactions[2]['sender_account_number'], None)
        self.assertTrue(transactions[2]['incomplete_remitter_info'])

        self.assertEqual(transactions[3]['sender_roll_number'], None)
        self.assertTrue(transactions[3]['incomplete_remitter_info'])
